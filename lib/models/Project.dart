...
class Project {
  ...
  final String? iosUrl, androidUrl;
...
List<Project> my_projects = [
  ...
  Project(
    ...
    specifications: [
      ...
      'Japanese and Korean voice functions',
      'Automatic listening function',
